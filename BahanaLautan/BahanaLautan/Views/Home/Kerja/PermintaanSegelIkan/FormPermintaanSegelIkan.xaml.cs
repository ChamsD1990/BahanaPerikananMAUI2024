...
namespace BahanaLautan.Views.Home.Kerja.PermintaanSegelIkan;

public partial class FormPermintaanSegelIkan : ContentPage
{
    ...
    double widths;
    public FormPermintaanSegelIkan()
    {
		InitializeComponent();
    ...
    public void InitTitle()
    {
        ...
        var TitleText = new VerticalStackLayout
        {
            Children =
            {
                new Label
                {
                    Text = "Form Permintaan Segel Ikan",
                    FontFamily = "Strande2",
