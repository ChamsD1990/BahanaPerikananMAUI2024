...
namespace BahanaLautan.Views.Home.Kerja.PermintaanAngkutanLogistik;

public partial class FormPermintaanAngkutanLogistik : ContentPage
{
    ...
    double widths;
    public FormPermintaanAngkutanLogistik()
    {
        InitializeComponent();
    ...
    public void InitTitle()
    {
        ...
        var TitleText = new VerticalStackLayout
        {
            Children =
            {
                new Label
                {
                    Text = "Form Permintaan Angkutan Logistik",
                    FontFamily = "Strande2",
