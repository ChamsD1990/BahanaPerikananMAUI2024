using BahanaLautan.Source.Utils.Data.Permintaan.PeralatanTangkap.Permintaan;
using BahanaLautan.Source.Utils.Data.Permintaan.PeralatanTangkap.Proses;
using BahanaLautan.Source.Utils.Data.Permintaan.PeralatanTangkap.Selesai;
using BahanaLautan.Views.Home.Permintaan.PerbaikanKapal;

namespace BahanaLautan.Views.Home.Permintaan.PeralatanTangkap;

public partial class ListPeralatanTangkap : ContentPage
{
            ...
            Children =
                {
                    new Label
                    {
                        Text = "Form Permintaan Peralatan",
                        FontFamily = "Strande2",
    ...
    {
        await Navigation.PushAsync(new FormPeralatanTangkap());
    }
    ...
    public void loadPermintaan()
    {
        ...
        v_permintaan.Padding = new Thickness(10, 0, 10, 0);
    }
    public View InitialListPermintaanPerbaikanKapal(ContentPage myContentPage)
    {
        ListPermintaan listPermintaan = new ListPermintaan(myContentPage, widths);
        return listPermintaan.LoadListPermintaan(); // Call LoadListPermintaan to get the View
    }
