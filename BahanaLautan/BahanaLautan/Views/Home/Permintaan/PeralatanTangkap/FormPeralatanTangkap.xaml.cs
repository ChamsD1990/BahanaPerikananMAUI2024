...
public partial class FormPeralatanTangkap : ContentPage
{
	public FormPeralatanTangkap()
	{
		InitializeComponent();
        OnAppearing();
        InitTitle();
    ...
    public async void BackButtons(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (pages[i] is ListPeralatanTangkap)
                {
    ...
    private void OnPickerJenisalatTangkap(object sender, EventArgs e)
    {
        //var picker = (Picker)sender;
        //if (picker.SelectedIndex != -1)
        //{
        //    SelectedLabel.Text = $"You selected: {picker.SelectedItem}";
        //}
    }
}