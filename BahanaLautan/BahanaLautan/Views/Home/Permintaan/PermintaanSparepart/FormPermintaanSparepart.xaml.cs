...
public partial class FormPermintaanSparepart : ContentPage
{
    ...
    double widths;
    public FormPermintaanSparepart()
    {
        InitializeComponent();
        OnAppearing();
    }
            ...
            Children =
                {
                    new Label
                    {
                        Text = "Form Permintaan Sparepart",
                        FontFamily = "Strande2",
                        TextColor = Colors.Black,
                        VerticalTextAlignment = TextAlignment.Center,
                        VerticalOptions = LayoutOptions.FillAndExpand,
    ...
    public async void BackButtons(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (pages[i] is ListPermintaanSparepart)
                {
