using BahanaLautan.Source.Utils.Data.Permintaan.PermintaanSparepart.Permintaan;
using BahanaLautan.Source.Utils.Data.Permintaan.PermintaanSparepart.Proses;
using BahanaLautan.Source.Utils.Data.Permintaan.PermintaanSparepart.Selesai;

namespace BahanaLautan.Views.Home.Permintaan.PermintaanSparepart;

public partial class ListPermintaanSparepart : ContentPage
{
    ...
    public ListPermintaanSparepart()
    {
        InitializeComponent();
        OnAppearing();
            ...
            Children =
                {
                    new Label
                    {
                        Text = "List Permintaan Sparepart",
                        FontFamily = "Strande2",
    ...
    {
        await Navigation.PushAsync(new FormPermintaanSparepart());
    }
