using BahanaLautan.Source.Utils.Data.Permintaan.PerbaikanKapal.Permintaan;
using BahanaLautan.Source.Utils.Data.Permintaan.PerbaikanKapal.Proses;
using BahanaLautan.Source.Utils.Data.Permintaan.PerbaikanKapal.Selesai;

namespace BahanaLautan.Views.Home.Permintaan.PerbaikanKapal;

public partial class ListPerbaikanKapal : ContentPage
{
    ...
    {
        await Navigation.PushAsync(new FormPerbaikanKapal());
    }
    ...
    public void initialTabView(HorizontalStackLayout frame)
    {
        ...
        btn_permintaan.BackgroundColor = Colors.Blue;
