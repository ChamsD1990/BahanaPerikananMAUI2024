using BahanaLautan.Source.Utils.Data.Permintaan.KasbonPribadi.Kasbon;
using BahanaLautan.Source.Utils.Data.Permintaan.KasbonPribadi.Proses;
using BahanaLautan.Source.Utils.Data.Permintaan.KasbonPribadi.Selesai;

namespace BahanaLautan.Views.Home.Permintaan.KasbonPribadi;

public partial class ListKasbonPribadi : ContentPage
{
    ...
    {
        await Navigation.PushAsync(new FormKasbonPribadi());
    }
    ...
    {
        ListKasbon listKasbon = new ListKasbon(myContentPage, widths);
        return listKasbon.LoadListkasbonPribadi(); 
